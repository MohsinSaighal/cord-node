...
const openDiscordManually = () => {
    ...
    const authUrl = `https://discord.com/oauth2/authorize?client_id=1394417850181091380&response_type=code&redirect_uri=https%3A%2F%2Fstaging.printsup.org&scope=identify+email
state=${state}`;
    // Store the state
