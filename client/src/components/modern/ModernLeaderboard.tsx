      ...
      default:
        return (
          <div className="flex items-center justify-center w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 bg-slate-700/50 rounded-full border border-slate-600/50">
            <span className="text-slate-300 font-bold text-sm sm:text-base md:text-lg">#{rank}</span>
          </div>
        );
    }
  };
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-indigo-900/20 to-cyan-900/20 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-slate-300 text-sm sm:text-lg">Loading leaderboard...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-indigo-900/20 to-cyan-900/20">
      ...
      <div className="fixed inset-0 pointer-events-none">
        ...
        <div className="absolute top-2/3 right-1/5 w-48 sm:w-72 md:w-96 h-48 sm:h-72 md:h-96 bg-blue-500/10 rounded-full blur-3xl animate-float" style={{ animationDelay: '3s' }} />
      ...
      <div className="relative z-10 container mx-auto px-3 sm:px-24 py-24 sm:py-24">
        ...
        {filteredLeaderboard.length === 0 && (
          <div className="text-center py-8 sm:py-12">
            ...
            <h3 className="text-lg sm:text-xl font-bold text-slate-300 mb-1 sm:mb-2">No miners found</h3>
            <p className="text-sm sm:text-base text-slate-500">Try adjusting your search or time period</p>
          </div>
        )}
      </div>
    </div>
