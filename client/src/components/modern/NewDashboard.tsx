...
import { API_BASE, useGlobalStats } from "../../hooks/useApi";
...
const StatCard = ({
  ...
  return (
    ...
    >
      ...
      <div
        className={cn("text-2xl lg:text-3xl font-bold mb-1 lg:mb-2", textColor)}
      >
        {value}
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto p-6 space-y-6 mt-20">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="flex-1">
              ...
              <p className="text-sm text-blue-200">
                Enter a referral code to get bonus rewards and boost your
                mining!
              </p>
            </div>
        ...
        <div className="bg-slate-800/40 backdrop-blur-sm border border-slate-700/50 rounded-2xl p-6">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6">
            ...
            <StatCard
              icon={Users}
              value={globalStats?.totalMiners || "Loading..."}
            ...
            <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between mb-6">
              <div>
                ...
                <div className="text-xs lg:text-sm text-slate-400">
                  Complete Tasks to earn CORD Tokens.
                </div>
              </div>
            </div>
