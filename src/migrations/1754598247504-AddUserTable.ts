...
export class AddUserTable1754598247504 implements MigrationInterface {
    name = 'AddUserTable1754598247504'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."tasks_type_enum" AS ENUM('daily', 'weekly', 'social', 'achievement')`);
        await queryRunner.query(`CREATE TABLE "tasks" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "title" character varying(255) NOT NULL, "description" text NOT NULL, "reward" numeric(15,8) NOT NULL, "type" "public"."tasks_type_enum" NOT NULL, "completed" boolean NOT NULL DEFAULT false, "progress" integer NOT NULL DEFAULT '0', "maxProgress" integer NOT NULL DEFAULT '1', "expiresAt" TIMESTAMP, "claimedAt" TIMESTAMP, "socialUrl" character varying(500), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "userId" character varying NOT NULL, CONSTRAINT "PK_8d12ff38fcc62aaba2cab748772" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "users" ("id" character varying(36) NOT NULL, "username" character varying(255) NOT NULL, "discriminator" character varying(10) NOT NULL, "avatar" character varying(255), "account_age" numeric(10,2) NOT NULL DEFAULT '0', "join_date" TIMESTAMP NOT NULL, "multiplier" numeric(10,2) NOT NULL DEFAULT '1', "compensationClaimed" boolean NOT NULL DEFAULT false, "hasbadgeofhonor" boolean NOT NULL DEFAULT false, "total_earned" numeric(15,8) NOT NULL DEFAULT '0', "current_balance" numeric(15,8) NOT NULL DEFAULT '0', "isNodeActive" boolean NOT NULL DEFAULT false, "tasksCompleted" integer NOT NULL DEFAULT '0', "rank" integer NOT NULL DEFAULT '0', "nodeStartTime" bigint, "last_login_time" bigint NOT NULL DEFAULT EXTRACT(epoch FROM NOW()) * 1000, "daily_checkin_claimed" boolean NOT NULL DEFAULT false, "weekly_earnings" numeric(15,8) NOT NULL DEFAULT '0', "monthly_earnings" numeric(15,8) NOT NULL DEFAULT '0', "referralCode" character varying(50), "referredBy" character varying(50), "referralEarnings" numeric(15,8) NOT NULL DEFAULT '0', "totalReferrals" integer NOT NULL DEFAULT '0', "currentEpochId" character varying(100), "epochJoinDate" bigint, "totalEpochEarnings" numeric(15,8) NOT NULL DEFAULT '0', "lastSavedBalance" numeric(15,8), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_fe0bb3f6520ee0469504521e710" UNIQUE ("username"), CONSTRAINT "UQ_b7f8278f4e89249bb75c9a15899" UNIQUE ("referralCode"), CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id"))`);
