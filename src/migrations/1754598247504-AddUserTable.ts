...
export class AddUserTable1754598247504 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "users" ("id" character varying(36) NOT NULL, "username" character varying(255) NOT NULL, "discriminator" character varying(10) NOT NULL, "avatar" character varying(255), "accountAge" numeric(10,2) NOT NULL DEFAULT '0', "joinDate" TIMESTAMP NOT NULL, "multiplier" numeric(10,2) NOT NULL DEFAULT '1', "compensationClaimed" boolean NOT NULL DEFAULT false, "hasBadgeOfHonor" boolean NOT NULL DEFAULT false, "totalEarned" numeric(15,8) NOT NULL DEFAULT '0', "currentBalance" numeric(15,8) NOT NULL DEFAULT '0', "isNodeActive" boolean NOT NULL DEFAULT false, "tasksCompleted" integer NOT NULL DEFAULT '0', "rank" integer NOT NULL DEFAULT '0', "nodeStartTime" bigint, "lastLoginTime" bigint NOT NULL DEFAULT EXTRACT(epoch FROM NOW()) * 1000, "dailyCheckInClaimed" boolean NOT NULL DEFAULT false, "weeklyEarnings" numeric(15,8) NOT NULL DEFAULT '0', "monthlyEarnings" numeric(15,8) NOT NULL DEFAULT '0', "referralCode" character varying(50), "referredBy" character varying(50), "referralEarnings" numeric(15,8) NOT NULL DEFAULT '0', "totalReferrals" integer NOT NULL DEFAULT '0', "currentEpochId" character varying(100), "epochJoinDate" bigint, "totalEpochEarnings" numeric(15,8) NOT NULL DEFAULT '0', "lastSavedBalance" numeric(15,8), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_fe0bb3f6520ee0469504521e710" UNIQUE ("username"), CONSTRAINT "UQ_b7f8278f4e89249bb75c9a15899" UNIQUE ("referralCode"), CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id"))`);
