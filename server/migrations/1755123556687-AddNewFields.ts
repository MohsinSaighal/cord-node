...
export class AddNewFields1755123556687 implements MigrationInterface {
    name = 'AddNewFields1755123556687'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "user_tasks" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "userId" character varying NOT NULL, "taskId" character varying(255) NOT NULL, "completed" boolean NOT NULL DEFAULT false, "progress" integer NOT NULL DEFAULT '0', "claimedAt" TIMESTAMP, "reward" numeric(15,2) NOT NULL DEFAULT '0', "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_07df033b0b61ee58ded3168bf2a" UNIQUE ("userId", "taskId"), CONSTRAINT "PK_dd5ebb5c408af74cba775bd2326" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_07df033b0b61ee58ded3168bf2" ON "user_tasks" ("userId", "taskId") `);
        await queryRunner.query(`CREATE TABLE "mining_sessions" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "userId" character varying NOT NULL, "startTime" TIMESTAMP NOT NULL, "endTime" TIMESTAMP, "earnings" numeric(15,2) NOT NULL DEFAULT '0', "hashRate" numeric(10,2) NOT NULL DEFAULT '0', "efficiency" numeric(5,2) NOT NULL DEFAULT '85', "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_0b5d0db436673e49212c8ce6db3" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "users" ("id" character varying(36) NOT NULL, "username" character varying(255) NOT NULL, "discriminator" character varying(10) NOT NULL, "avatar" character varying(255), "accountAge" numeric(10,2) NOT NULL DEFAULT '0', "joinDate" TIMESTAMP NOT NULL, "multiplier" numeric(10,2) NOT NULL DEFAULT '1', "compensationClaimed" boolean NOT NULL DEFAULT false, "hasBadgeOfHonor" boolean NOT NULL DEFAULT false, "totalEarned" numeric(15,2) NOT NULL DEFAULT '0', "currentBalance" numeric(15,2) NOT NULL DEFAULT '0', "isNodeActive" boolean NOT NULL DEFAULT false, "tasksCompleted" integer NOT NULL DEFAULT '0', "rank" integer NOT NULL DEFAULT '0', "nodeStartTime" bigint, "lastLoginTime" bigint NOT NULL DEFAULT EXTRACT(epoch FROM NOW()) * 1000, "dailyCheckInClaimed" boolean NOT NULL DEFAULT false, "weeklyEarnings" numeric(15,2) NOT NULL DEFAULT '0', "monthlyEarnings" numeric(15,2) NOT NULL DEFAULT '0', "referralCode" character varying(50), "referredBy" character varying(50), "referralEarnings" numeric(15,2) NOT NULL DEFAULT '0', "totalReferrals" integer NOT NULL DEFAULT '0', "currentEpochId" character varying(100), "epochJoinDate" bigint, "totalEpochEarnings" numeric(15,2) NOT NULL DEFAULT '0', "lastSavedBalance" numeric(15,2), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_fe0bb3f6520ee0469504521e710" UNIQUE ("username"), CONSTRAINT "UQ_b7f8278f4e89249bb75c9a15899" UNIQUE ("referralCode"), CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "badge_purchases" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "userId" character varying NOT NULL, "walletAddress" character varying(64) NOT NULL, "transactionHash" character varying(120) NOT NULL, "amountSol" numeric(10,6) NOT NULL, "amountUsd" numeric(10,2) NOT NULL, "purchaseDate" TIMESTAMP NOT NULL DEFAULT now(), "status" character varying(20) NOT NULL DEFAULT 'pending', CONSTRAINT "UQ_109cca5a2377719b7d04aaf9106" UNIQUE ("transactionHash"), CONSTRAINT "PK_d38e9dc5e66bf7082983081878f" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "badge_purchases" ADD CONSTRAINT "FK_edca14ae8aac5929723f477a42d" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "badge_purchases" DROP CONSTRAINT "FK_edca14ae8aac5929723f477a42d"`);
